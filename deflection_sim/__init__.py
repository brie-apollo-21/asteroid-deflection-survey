from . import gmatpy as gmat
import os
import math

def run_simulation(spk, naif_id, epoch, v1=None, v2=None, v3=None, magnitude=None, ra=None, dec=None):
    gmat.LoadScript("asteroid_deflection.script")
